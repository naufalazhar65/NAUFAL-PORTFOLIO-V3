...
export default function Inspector() {
  ...
  const timing = useExecutionStore(
    (state) =>
      selectedNode
  ...
  if (!selectedNode) {
    return (
      <aside className="border-l border-white/10 bg-[#111827] p-6">
        <h2 className="mb-6 text-sm font-semibold uppercase tracking-[3px] text-gray-400">
          Inspector
        </h2>
  ...
  return (
    <aside className="overflow-y-auto border-l border-white/10 bg-[#111827] p-6">
      <h2 className="mb-6 text-sm font-semibold uppercase tracking-[3px] text-gray-400">
        Inspector
      </h2>
